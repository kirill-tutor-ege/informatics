...
# Наименьший А, истинно при любом х (тождественно истинно)
...
# Наибольший А, истинно при любом х (тождественно истинно)
f = lambda x, A: ((x & 112 != 0) or (x & 86 != 0)) <= ((x & 65 == 0) <= (x & A != 0))
for A in range(1, 10000):
    if all(f(x, A) for x in range(1, 100000)):
        print(A) # В ответ идет последнее число, выведенное на экран

# Наименьший А, истинно при хотя бы одном х (найдется такое значение х)
f = lambda x, A: ((x & 112 != 0) or (x & 86 != 0)) <= ((x & 65 == 0) <= (x & A != 0))
for A in range(1, 100):
...
# Наибольший А, истинно при хотя бы одном х (найдется такое значение х)
f = lambda x, A: ((x & 112 != 0) or (x & 86 != 0)) <= ((x & 65 == 0) <= (x & A != 0))
for A in range(1, 100):
    if any(f(x, A) for x in range(1, 100000)):
        print(A) # В ответ идет последнее число, выведенное на экран

# Наименьший А, ложно при любом х (тождественно ложно)
f = lambda x, A: ((x & 112 != 0) or (x & 86 != 0)) <= ((x & 65 == 0) <= (x & A != 0))
for A in range(1, 100):
...
# Наибольший А, ложно при любом х (тождественно ложно)
f = lambda x, A: ((x & 112 != 0) or (x & 86 != 0)) <= ((x & 65 == 0) <= (x & A != 0))
for A in range(1, 100):
    if all(not f(x, A) for x in range(1, 100000)):
        print(A) # В ответ идет последнее число, выведенное на экран

# Наименьший А, ложно при хотя бы одном х (найдется такое значение х)
f = lambda x, A: ((x & 112 != 0) or (x & 86 != 0)) <= ((x & 65 == 0) <= (x & A != 0))
for A in range(1, 100):
...
# Наибольший А, ложно при хотя бы одном х (найдется такое значение х)
f = lambda x, A: ((x & 112 != 0) or (x & 86 != 0)) <= ((x & 65 == 0) <= (x & A != 0))
for A in range(1, 100):
    if any(not f(x, A) for x in range(1, 100000)):
        print(A) # В ответ идет последнее число, выведенное на экран
